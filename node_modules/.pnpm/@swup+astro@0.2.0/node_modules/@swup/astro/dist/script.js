...
export function buildInitScript(options = {}) {
    let { accessibility = true, animationClass = 'transition-', cache = true, containers = ['main'], debug = false, globalInstance = false, loadOnIdle = true, preload = true, progress = false, reloadScripts = true, routes = false, smoothScrolling = true, theme = 'fade', updateBodyClass = true, updateHead = true, } = options;
